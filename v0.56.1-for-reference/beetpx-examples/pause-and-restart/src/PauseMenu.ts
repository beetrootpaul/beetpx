import {$d, $rgb, $rgb_p8, $u, $v, $v_0_0, $x, BpxCanvasSnapshotColorMapping, BpxColorMapper,} from "@beetpx/beetpx";
...
export class PauseMenu {
    ...
    draw() {
        ...
        const xy = (itemIndex: number) => $v(8 + (this.#selectedItem === itemIndex ? 4 : 0), 8 + itemIndex * 20);
        const color = (itemIndex: number) => this.#selectedItem === itemIndex ? $rgb_p8.white : $rgb_p8.slate;
