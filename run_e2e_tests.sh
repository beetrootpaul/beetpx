...
npx playwright test --config e2e_tests/htmlIcon__custom__dev.config.ts
npx playwright test --config e2e_tests/htmlIcon__custom__prod.config.ts
npx playwright test --config e2e_tests/htmlIcon__default__dev.config.ts
npx playwright test --config e2e_tests/htmlIcon__default__prod.config.ts
