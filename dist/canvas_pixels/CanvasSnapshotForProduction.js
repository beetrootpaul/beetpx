...
export class CanvasSnapshotForProduction {
    ...
    get(index) {
        ...
        return new BpxSolidColor(__classPrivateFieldGet(this, _CanvasSnapshotForProduction_imageDataData, "f")[dataIndex], __classPrivateFieldGet(this, _CanvasSnapshotForProduction_imageDataData, "f")[dataIndex + 1], __classPrivateFieldGet(this, _CanvasSnapshotForProduction_imageDataData, "f")[dataIndex + 2]);
    }
}
