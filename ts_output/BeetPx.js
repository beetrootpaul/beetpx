...
class BeetPx {
    ...
    static init(frameworkOptions, assetsToLoad) {
        __classPrivateFieldSet(BeetPx, _a, new Framework_1.Framework(frameworkOptions), "f", _BeetPx_framework);
        return __classPrivateFieldGet(BeetPx, _a, "f", _BeetPx_framework).loadAssets(assetsToLoad);
    }
    ...
    static setOnUpdate(onUpdate) {
        __classPrivateFieldGet(BeetPx, _a, "f", _BeetPx_framework).setOnUpdate(onUpdate);
    }
    static setOnDraw(onDraw) {
        __classPrivateFieldGet(BeetPx, _a, "f", _BeetPx_framework).setOnDraw(onDraw);
    }
    // Debug flag.
    //
    static get debug() {
