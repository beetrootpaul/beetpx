...
env:
  macOS Sonoma 14.1.1 (Apple M1 Max), Firefox 121.0 (64-bit)
gamepad:
  8BitDo Lite 2
gamepad ID:
...
buttons:
 ...
 axes and their ranges:
  - left  stick, horizontal -> 1 (left -1.00 : 1.00 right)
  - left  stick, vertical   -> 2 (  up -1.00 : 1.00 down )
  - right stick, horizontal -> 3 (left -1.00 : 1.00 right)
  - right stick, vertical   -> 4 (  up -1.00 : 1.00 down )
  - L2                      -> 6 (idle -1.00 : 1.00 pushed, no mid values)
  - R2                      -> 5 (idle -1.00 : 1.00 pushed, no mid values)
  - dpad -> 0 (from -1.00 +2/7 for each 1/8 turn clockwise:
                 up         -1.00
                 up-right   -0.71
                 right      -0.43
                 down-right -0.14
...
export class GamepadMappingFirefox8BitDoOther implements GamepadMapping {
  ...
  eventsForAxisValue(
    ...
    switch (axisIndex) {
      ...
      case 2: // left stick, vertical
      case 4: // right stick, vertical
        return (
          axisValue > GamepadMappingFirefox8BitDoOther.#stickAxisThreshold ?
            ["button_down"]
          : axisValue < -GamepadMappingFirefox8BitDoOther.#stickAxisThreshold ?
